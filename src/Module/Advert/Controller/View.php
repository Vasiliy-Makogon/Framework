...
class View extends Controller
{
    public function run()
    {
        ...
        if (!$this->getRequest()->getGet('notif', 'decimal')) {
            ...
            if (!Request::IfModifiedSince($advert_data['advert']->getLastModifiedDate())) {
        ...
        $this->getView()->getHelper('\Krugozor\Framework\Html\Title')->add(
            Strings::trimPunctuation($advert_data['advert']->getHeader()) .
