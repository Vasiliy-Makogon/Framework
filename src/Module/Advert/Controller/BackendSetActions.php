 ...
 */
class Krugozor_Module_Advert_Controller_BackendSetActions extends Krugozor_Controller
{
    public function run()
    {
        ...
        $adverts = $this->getMapper('Advert/Advert')->findModelListByIds($this->getRequest()->getRequest('ids')->getData());
