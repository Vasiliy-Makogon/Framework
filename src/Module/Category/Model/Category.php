...
class Category extends Model
{
     ...
     * @return $this
     */
    public function setTree(CoverArray $tree)
    {
        $this->tree = $tree;
     ...
     * @param array
     */
    public function setUrlFromTreePath(CoverArray $tree)
    {
    ...
    {
        return Translit::UrlTranslit($alias);
    }
     ...
     */
    protected static function getAliasesFromTree(CoverArray $tree)
    {
        if (!$tree instanceof CoverArray || !$tree->count()) {
            return false;
        }
