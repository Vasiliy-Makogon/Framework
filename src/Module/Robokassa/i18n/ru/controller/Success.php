...
(
    ...
    'advert_set_vip' => '<p>Платёж успешно совершён.</p>' .
                        ...
                        'Это значит, что его увидят больше посетителей сайта и Ваше объявление с большей вероятностью 
                        попадёт в кэш поисковых систем интернета, что со временем даст постоянный приток поситителей 
