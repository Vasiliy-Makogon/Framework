...
abstract class Krugozor_Thumbnail_Creator
{
    /**
     ...
     *
     * @param text текст для надписи в левом нижнем углу
     * @return bool
     */
    public function resize($text = null)
    {
        $this->validateactual_width();
     ...
     * @return bool
     */
    abstract protected function storeImage($thumbnail);
...
//            );
     ...
     * @return bool
     */
    private function executeResize($text = null)
    {
