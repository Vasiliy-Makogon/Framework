...
class Krugozor_Html_ElementSelect extends Krugozor_Html_Element
{
    // Значение.
    ...
    */
    ...
    protected function createDocObject()
    {
        ...
        foreach ($this->options as $option) {
            if ($option instanceof Krugozor_Html_ElementOptgroup) {
            ...
            } else if ($option instanceof Krugozor_Html_ElementOption) {
