...
class Krugozor_Helper_Format
{
     ...
     *
     * @param string строка, возможно с параметрами как у Krugozor_Static_String::createMessageFromParams
     * @param array $params массив с параметрами как у Krugozor_Static_String::createMessageFromParams
     * @return string
     * @static
     */
    public static function js($str, $params = array())
    {
        ...
        if ($params) {
            ...
            $str = Krugozor_Static_String::createMessageFromParams($str, $params, false);
        }
     ...
     *
     * @param int величина
     * @param array|Krugozor_Cover_Array
     * @return string
     * @static
     */
